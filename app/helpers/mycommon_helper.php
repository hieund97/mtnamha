...
if (!function_exists('htmlItem')) {

    function htmlItem($valPost = null, $bool)

    {
        ...
        $image = (!empty($valPost['images'])) ? $valPost['images'] : 'templates/frontend/resources/images/not-found.png';


        $percent = 0;
        if(!empty($valPost['price'] && !empty($valPost['saleoff']))){

            $percent = round((($valPost['price']-$valPost['saleoff'])*100)/$valPost['price']);

        }

        $stock = $valPost['isfooter'];

        $img_pos = (($valPost['ishome'] == 1) ? '' : 'top-0');

        if($stock == 0){

            $is_stock = '<span class="icon-is-stock"><i class="fa fa-check" aria-hidden="true"></i> Còn hàng</span>';

        }else{

            $is_stock = '<span class="icon-none-is-stock"><i class="fa fa-phone" aria-hidden="true"></i> Hết hàng</span>';
        ...
        $html .= '<div class="item-product">
                        ...
                        <div class="image">
                            ...
                            <a href="' .$href. '" class="thubmail-img">';

        if($bool == true) {

            $html .= '<img class="lazy" data-src="' . $image . '" alt="' . $title . '">';
        ...
        $html .= '</a>
                            ...
                            <a href="' .$href. '" class="quick-view" data-link-action="quickview">
        ...
        if($valPost['ishome'] == 1) {
            $html .= '<div class="new-pr">

                        <img class="lazy" data-src="templates/frontend/resources/images/new.png" alt="">
        ...
        if($percent > 0) {
            ...
            $html .= '<div class="sale-pr '. $img_pos .'">

                        <img class="lazy" data-src="templates/frontend/resources/images/sale.png" alt="sale">
        ...
        if(!empty($valPost['price']) && !empty($valPost['saleoff'])) {
            ...
            $html .= '<p class="price">
                                ...
                                <span class="gia-moi">'. number_format($valPost['saleoff']) .' đ</span>

                                <span class="gia-cu">'. number_format($valPost['price']) .' đ</span>

                                <span class="tiet-kiem">(Tiết kiệm: '.$percent.'%)</span>  

                            </p>';

        } elseif (!empty($valPost['price']) && empty($valPost['saleoff'])){

            $html .= '<p class="price"><span class="gia-moi">'. number_format($valPost['price']) .' đ</span></p>';

        } else{

            $html .= '<p class="price"><span class="gia-moi">Liên hệ</span></p>';

        }

        $html .='<div class="sale-off-show">-100%</div>
                        ...
                        <div class="add-cart">
                            ...
                            <a class="is-stock">'. $is_stock .'</a>

                            <a href="" class="ajax-addtocart button-single-cart pc-add-cart" data-quantity="1" data-id="' .$id. '" data-price="0"><i class="fa fa-cart-plus" aria-hidden="true"></i> Thêm vào giỏ</a>

                            <a href="" class="ajax-addtocart button-single-cart mobile-add-cart" data-quantity="1" data-id="' .$id. '" data-price="0" style="display: none"><i class="fa fa-cart-plus" aria-hidden="true"></i> Giỏ hàng</a>

                            <a href="" class="mh ajax-addtocart hidden-box" data-redirect="redirect" data-quantity="1" data-id="' .$id. '" data-price="0">Mua hàng</a>
