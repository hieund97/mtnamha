...
<!--                                        <th>Trạng thái</th>-->
                                    ...
                                    <?php foreach ($OrderList as $key => $val): ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo str_replace(',', '.', number_format($val['total_price'])) ?> đ</td>
                                            <td><?php echo $val['created'] ?></td>
                                            <td>
                                                <button class="btn btn-white btn-sm btn-<?php echo $val['status'] ?>">
                                                    <?php echo $this->configbie->data('status_w', $val['status']) ?>
                                                </button>
                                            </td>
<!--                                            <td>-->
<!--                                                <button class="btn btn-white btn-sm --><?php //echo ((!empty($val['process'])) ? 'btn-success' : 'btn-danger') ?><!--">-->
<!--                                                    --><?php ////echo $this->configbie->data('process_w', $val['process']) ?>
<!--                                                    --><?php //echo $val['process'] ?>
<!--                                                </button>-->
<!--                                            </td>-->
<!--                                            <td>-->
<!--                                                --><?php //echo ((!empty($val['process'])) ? show_time($val['updated'], 'd-m-Y') : 'Chưa xác định') ?>
<!--                                            </td>-->
                                            <td><a href="order-information.html?id=<?php echo $val['id'] ?>">Xem chi tiết</a></td>
                                        </tr>
                                    <?php endforeach ?>
                                    </tbody>
                                </table>
