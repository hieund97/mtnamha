					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab-seo">
							<div class="box-body">
								...
								<div class="form-group">
									<label style="white-space: normal;" class="col-sm-12 control-label tp-text-left">Hiển thị list trong tin tức url(tin-tuc.html) Chỉ áp dụng cho danh mục gốc</label>
								</div>
								<div class="form-group">
									<div class="col-sm-12">
										<?php echo form_dropdown('is_show', $this->configbie->data('isaside'), set_value('is_show', $DetailArticlesCatalogues['is_show']), 'class="form-control" style="width: 100%;"');?>
									</div>
								</div>
								<div class="form-group">
