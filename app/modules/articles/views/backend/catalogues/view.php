		...
		<div class="box-body table-responsive no-padding">
			...
			<table class="table table-hover" id="diagnosis-list">
				<tr>
					...
					<th>Nổi bật</th>
					<th>Cột Aside</th>
					<th>Hiển thị trong tin-tuc.html</th>
					<!-- <th>Menu top</th> -->
				...
				<tr>
					...
					<td>
						<?php if ($item['parentid'] == 0): ?>
							<a href="<?php echo site_url('articles/backend/catalogues/set/is_show/'.$item['id'].'?redirect='.urlencode(current_url())); ?>" title="" class="status-publish">
								<img src="<?php echo (!empty($item['is_show']))? 'templates/backend/images/publish-check.png':'templates/backend/images/publish-deny.png'; ?>" alt="" />
							</a>
						<?php else: ?>
							<a href="javascript:void(0)" title="" class="status-publish">
								<img src="<?php echo (!empty($item['is_show']))? 'templates/backend/images/publish-check.png':'templates/backend/images/publish-deny.png'; ?>" alt="" />
							</a>
						<?php endif ?>
