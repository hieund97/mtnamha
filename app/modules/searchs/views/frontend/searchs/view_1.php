				...
				<div class="rightContent">
					<section class="productCatalogue"><!-- DANH MỤC SẢN PHẨM -->
						<header class="panel-head skin-1 uk-flex uk-flex-middle uk-flex-space-between">
							<h2 class="heading-1"><a href="" title="Tìm kiếm" onclick="return false;">Tìm kiếm từ khóa: <?php echo $this->input->get('keyword'); ?></a></h2>
						</header>
						...
						<?php }else{ echo '<div class="mt10">Không có dữ liệu phù hợp ...</div>'; }  ?>
