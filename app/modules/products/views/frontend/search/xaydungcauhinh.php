                    ...
                    <div id="pcbuilder_box" class="view-content">
                        <div id="pc_part_select">
                            <ul>
                                ...
                                ?>
                                <?php if (isset($danhmucsearch) && is_array($danhmucsearch) && count($danhmucsearch)) {
                                    foreach ($danhmucsearch as $key => $val) { ?>
                                        <?php if($key == 0) $step = $val['order']; ?>
                                        <li>
...
<input type="hidden" id="price_chonlai" value=""/>
<input type="hidden" id="pcbuilder_step" value="<?php echo $step; ?>"/>
...
//        alert(amount);
       ...
       // alert(total);
        ...
        if ($("#part_selected_" + c).length == 0) {
            ...
            j += '<a href="javascript:pcbuilder_back_step(' + c + ", " + d + ", " + h + ", " + total + ')">Chọn lại</a> - <a href="javascript:pcbuilder_remove_part(' + c + ", " + d + ", " + h + ", " + total + ')">Xóa bỏ</a></p>';
